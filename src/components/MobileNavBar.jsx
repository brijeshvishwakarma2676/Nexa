...
export default function MobileNavBar() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-(--color-border) lg:hidden z-40 safe-area-bottom">
                    ...
                    return (
                        <button
                            ...
                            className={`flex flex-col items-center justify-center gap-1 px-4 py-2 rounded-lg transition-all ${active
                                    ? 'text-(--color-primary)'
                                    : 'text-(--color-text-muted) hover:text-(--color-text-primary) hover:bg-(--color-bg)'
                                }`}
                        >
